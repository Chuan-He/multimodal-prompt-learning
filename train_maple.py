...
if __name__ == "__main__":
    ...
    parser.add_argument("--output-dir", type=str, default="output/base2new/test_new/eurosat/maple", help="output directory")
    parser.add_argument(
        "--resume",
        type=str,
        default="",
    ...
    parser.add_argument(
        "--config-file", type=str, default="configs/trainers/MaPLe/vit_b16_c2_ep5_batch4.yaml", help="path to config file"
    )
    parser.add_argument(
        "--dataset-config-file",
        type=str,
    ...
    parser.add_argument(
        "--model-dir",
        type=str,
        default="output/base2new/test_new/eurosat/maple",
