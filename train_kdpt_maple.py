...
def extend_cfg(cfg):
    ...
    cfg.TRAINER.KDPT_MAPLE.N = 2 # the number of our text prompts
...
if __name__ == "__main__":
    ...
    parser.add_argument("--output-dir", type=str, default="output/base2new/test_new/eurosat/KDPT_MAPLE", help="output directory")
    parser.add_argument(
        "--resume",
        type=str,
        default="",
    ...
    parser.add_argument(
        "--config-file", type=str, default="configs/trainers/KDPT_MAPLE/test.yaml", help="path to config file"
    )
    parser.add_argument(
        "--dataset-config-file",
        type=str,
    ...
    parser.add_argument(
        "--model-dir",
        type=str,
        default="output/base2new/test_new/eurosat/KDPT_MAPLE",
