...
from trainers.constants_1_1 import get_dataset_specified_config_1_1
...
def extend_cfg(cfg):
    ...
    cfg.TRAINER.KDPT_MAPLE_1_1.N_CTX = 4  # number of context vectors
    ...
    cfg.TRAINER.KDPT_MAPLE_1_1.LAMDA = 0.1
    cfg.TRAINER.COS = True
    cfg.TRAINER.W_T = 4.0
    cfg.TRAINER.W_I = 1.0
    cfg.OPTIM_VNET = CN()
    cfg.OPTIM_VNET.NAME = "sgd"
...
def setup_cfg(args):
    ...
    cfg.merge_from_list(get_dataset_specified_config_1_1(cfg.DATASET.NAME))
...
if __name__ == "__main__":
    ...
    parser.add_argument("--output-dir", type=str, default="output/base2new/test_new/eurosat/", help="output directory")
    parser.add_argument(
        "--resume",
        type=str,
        default="",
    ...
    parser.add_argument(
        "--config-file", type=str, default="configs/trainers/KDPT_MAPLE_1_1/test.yaml", help="path to config file"
    )
    parser.add_argument(
        "--dataset-config-file",
        type=str,
    ...
    parser.add_argument("--trainer", type=str, default="KDPT_MAPLE_1_1", help="name of trainer")
    ...
    parser.add_argument(
        "--model-dir",
        type=str,
        default="output/base2new/test_new/eurosat/",
