...
def extend_cfg(cfg):
    ...
    cfg.TRAINER.KDPT_MAPLE_2.PROMPT_DEPTH = 9 # Max 12, minimum 0, for 1 it will act as shallow MaPLe (J=1)
    cfg.TRAINER.KDPT_MAPLE_2.N = 4 # the number of our text prompts
    cfg.TRAINER.W = 2.0
    cfg.TRAINER.W1 = 2.0
    cfg.TRAINER.W2 = 2.0
    cfg.TRAINER.W3 = 1.0
...
if __name__ == "__main__":
    ...
    parser.add_argument("--output-dir", type=str, default="output/base2new/test_new/eurosat/KDPT_MAPLE_2", help="output directory")
    parser.add_argument(
        "--resume",
        type=str,
        default="",
    ...
    parser.add_argument(
        "--config-file", type=str, default="configs/trainers/KDPT_MAPLE_2/test.yaml", help="path to config file"
    )
    parser.add_argument(
        "--dataset-config-file",
        type=str,
    ...
    parser.add_argument("--trainer", type=str, default="KDPT_MAPLE_2", help="name of trainer")
    ...
    parser.add_argument(
        "--model-dir",
        type=str,
        default="output/base2new/test_new/eurosat/KDPT_MAPLE_2",
