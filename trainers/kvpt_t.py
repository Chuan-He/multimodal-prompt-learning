...
class MultiModalPromptLearner(nn.Module):
    def __init__(self, cfg, classnames, clip_model):
        ...
        n_ctx = cfg.TRAINER.KVPT_T.N_CTX
        ctx_init = cfg.TRAINER.KVPT_T.CTX_INIT
        ...
        print('KVPT_T design: Multi-modal Prompt Learning')
...
class KVPT_T(TrainerX):
    """
    It is based on PLOT.
    """
    
    def check_cfg(self, cfg):
        assert cfg.TRAINER.KVPT_T.PREC in ["fp16", "fp32", "amp"]
    ...
    def forward_backward(self, batch):
        ...
        loss = F.cross_entropy(logits, label) + self.w*scores_text
