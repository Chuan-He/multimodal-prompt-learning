...
def load_clip_to_cpu(cfg):
    ...
    try:
        ...
        state_dict = torch.load(model_path, map_location="cpu")
    design_details = {"trainer": 'KMVPT_T',
                      "vision_depth": 0,
                      "language_depth": 0, "vision_ctx": 0,
                      "language_ctx": 0,
                      "maple_length": cfg.TRAINER.KMVPT_T.N_CTX}
    model = clip.build_model(state_dict or model.state_dict(), design_details)
...
class MultiModalPromptLearner(nn.Module):
    def __init__(self, cfg, classnames, clip_model):
        ...
        n_ctx = cfg.TRAINER.KMVPT_T.N_CTX
        ctx_init_flag = cfg.TRAINER.KMVPT_T.CTX_INIT
        dtype = clip_model.dtype
        ctx_dim = clip_model.ln_final.weight.shape[0]
        clip_imsize = clip_model.visual.input_resolution
        cfg_imsize = cfg.INPUT.SIZE[0]
        N = cfg.TRAINER.KMVPT_T.N   # the number of our text prompts 
        ...
        print('KMVPT_T design: Multi-modal Prompt Learning')
...
class CustomCLIP(nn.Module):
    def __init__(self, cfg, classnames, clip_model):
        ...
        self.N = cfg.TRAINER.KMVPT_T.N #+ len(clip_template[cfg.DATASET.NAME])
...
class KMVPT_T(TrainerX):
    """
    It is based on PLOT.
    """
    
    def check_cfg(self, cfg):
        assert cfg.TRAINER.KMVPT_T.PREC in ["fp16", "fp32", "amp"]
    ...
    def build_model(self):
        ...
        self.w = 1.0 #cfg.TRAINER.KMVPT_T.W
