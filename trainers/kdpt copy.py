...
class MultiModalPromptLearner(nn.Module):
    def __init__(self, cfg, classnames, clip_model):
        ...
        n_ctx = cfg.TRAINER.KDPT.N_CTX
        ctx_init = cfg.TRAINER.KDPT.CTX_INIT
        ...
        print('KDPT design: Multi-modal Prompt Learning')
    ...
    def forward(self):
        ...
        return prompts, self.proj(self.ctx)  # pass here original, as for visual 768 is required
...
class KDPT(TrainerX):
    ...
    def check_cfg(self, cfg):
        assert cfg.TRAINER.KDPT.PREC in ["fp16", "fp32", "amp"]
