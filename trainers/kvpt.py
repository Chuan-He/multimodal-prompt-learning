...
class MultiModalPromptLearner(nn.Module):
    def __init__(self, cfg, classnames, clip_model):
        ...
        n_ctx = cfg.TRAINER.KVPT.N_CTX
        ctx_init = cfg.TRAINER.KVPT.CTX_INIT
        ...
        print('KVPT design: Multi-modal Prompt Learning')
...
class KVPT(TrainerX):
    ...
    def check_cfg(self, cfg):
        assert cfg.TRAINER.KVPT.PREC in ["fp16", "fp32", "amp"]
    ...
    def forward_backward(self, batch):
        ...
        loss = F.cross_entropy(logits, label) + 0.8 * scores_text + 0.8 * scores_image
