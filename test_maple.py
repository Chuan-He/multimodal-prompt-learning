...
if __name__ == "__main__":
    ...
    parser.add_argument("--output-dir", type=str, default="output/base2new/test_new/ucf101/maple", help="output directory")
    parser.add_argument(
        "--resume",
        type=str,
        default="",
    ...
    parser.add_argument(
        "--model-dir",
        type=str,
        default="output/base2new/test_new/ucf101/maple",
